...
PAGE_NAMES = {
    '266156050143189': 'El Empaque + Conversión',
    '688595984534202': 'Metalmecanica.com',
    '333541433377510': 'Plastico.com',
    '144288335594945': 'IAlimentos',
    '485201118209108': 'Manufactura-Latam.com',
    '273229526208636': 'Axioma B2B Marketing',
    '144535808898199': 'En-Obra.com',
    '111284855622604': 'La Barra',
    '587453818082309': 'ElHospital.com',
    '145912368761294': 'Fierros.com.co'
}

def load_facebook_data():
    """Cargar y combinar datos de Facebook desde ambos archivos Excel"""
    try:
        ...
        df1 = pd.read_excel(
            "redes_sociales/facebook/General_Insights_Facebook_Parte_I.xlsx",
            dtype=dtype_dict
        )
        ...
        df2 = pd.read_excel(
            "redes_sociales/facebook/General_Insights_Facebook_Parte_II.xlsx",
            dtype=dtype_dict
        )
        ...
        df['Page Name'] = df['Page Id'].map(PAGE_NAMES)
...
def calculate_monthly_metrics(df, start_date=None, end_date=None):
    ...
    metrics_to_analyze = [col for col in non_unique_columns if col not in ['Page Id', 'Date', 'Page Name']]
...
def show_facebook_metrics():
    """Función principal para mostrar el dashboard de Facebook"""
    st.header("Análisis de Métricas de Facebook")
    ...
    # Selector de métrica
    metric_options = [col for col in df.columns if 'Unique' not in col and col not in ['Page Id', 'Date', 'Month', 'Page Name']]
